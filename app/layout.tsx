...
export const metadata: Metadata = {
  title: "Võ Hoàng Tùng - Software Developer",
  description:
  ...
  authors: [{ name: "Võ Hoàng Tùng" }],
  creator: "Võ Hoàng Tùng",
  openGraph: {
    title: "Võ Hoàng Tùng - Software Developer Portfolio",
    description:
    ...
    siteName: "Võ Hoàng Tùng - Portfolio",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Võ Hoàng Tùng - Modern Minimal Portfolio",
      },
    ],
    locale: "en_US",
    type: "website",
